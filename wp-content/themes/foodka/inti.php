...
<head>
    ...
    <!--fivicon icon-->
    <link rel="icon" href="<?php echo get_template_directory_uri().'/assets/img/fevicon.png' ?>">
    ...
    <header class="navbar-area">
        <nav class="navbar navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="logo">
                    <a class="main-logo" href="home-1.html"><img src="<?php echo get_template_directory_uri().'/assets/img/logo.png' ?>" alt="logo"></a>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="footer-widget widget">
                            ...
                            <ul class="contact_info_list">
                                <li class="single-info-item">
                                    <img src="<?php echo get_template_directory_uri().'/assets/img/icon/location.png' ?>" alt="icon">
                                    <div class="details">
                                        4920 Trails End Road Ft  United States, FL 33311
                                    </div>
                                </li>
                                <li class="single-info-item">
                                    <img src="<?php echo get_template_directory_uri().'/assets/img/icon/envelope.png' ?>" alt="icon">
                                    <div class="details">
                                        ordernow@foodka.com
                                    </div>
                                </li>
                                <li class="single-info-item">
                                    <img src="<?php echo get_template_directory_uri().'/assets/img/icon/phone.png' ?>" alt="icon">
                                    <div class="details">
                                        +997 509 153 849
                                    </div>
                                </li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget widget widget_instagram_feeds">
                            ...
                            <ul>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/1.png' ?>" alt="instagram" /></a></li>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/2.png' ?>" alt="instagram" /></a></li>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/3.png' ?>" alt="instagram" /></a></li>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/4.png' ?>" alt="instagram" /></a></li>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/5.png' ?>" alt="instagram" /></a></li>
                                <li><a href="#"><img src="<?php echo get_template_directory_uri().'/assets/img/instagram/6.png' ?>" alt="instagram" /></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
